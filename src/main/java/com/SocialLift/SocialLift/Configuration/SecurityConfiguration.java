package com.SocialLift.SocialLift.Configuration;
...
public class SecurityConfiguration {
        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers("/doc/**", "swagger-ui/**", "swagger-ui**", "/v3/api-docs/**", "/v3/api-docs**").permitAll()
    ...
    JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        converter.setAuthoritiesClaimName("https://socialLift_team/roles");
